...
![Cables trazados entre componentes, con puntos de conexión.](./images/wire-circuit-display.webp)
...
![Dos cruces: uno sin punto y otro unido por un punto de conexión.](./images/wire-junction.webp)
...
![Dos túneles con la misma etiqueta, sin cable entre ellos.](./images/tunnel.webp)
