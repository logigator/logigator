...
![The editor with the component palette, the board and the toolbar.](./images/board-overview.webp)
...
| ---------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Pan**    | `P`      | Drag to move the board, or the current selection; scroll or pinch to zoom.                                                                                                                   |
| **Wire**   | `W`      | Drag to draw wires; tap a port to negate it, or tap a crossing to connect or split; a tap that hits neither selects what is under it. See [Wires & Connections](docs:wires-and-connections). |
...
![The scissor toggle pill floating above the board.](./images/scissor-select.webp)
