...
export class EraseSession implements DragSession {
  ...
  // so by onEnd the instances are gone and only these points can tell the
  // integrator which collinear pairs lost their junction.
  ...
  onEnd(): void {
    ...
    // The removals may have left a collinear pair touching at a point that
    // lost its third terminator (I3).
