...
import customComponentShowcase from '@assets/docs/images/custom-component-showcase.gif';
...
import inspectionShowcase from '@assets/docs/images/inspection-showcase.gif';
...
import negatedGate from '@assets/docs/images/negated-gate.gif';
...
import tunnel from '@assets/docs/images/tunnel.gif';
...
export const DOC_IMAGES: Readonly<Record<string, string>> = {
  ...
  '../images/custom-component-showcase.gif': customComponentShowcase,
  '../images/custom-component-tab.png': customComponentTab,
  '../images/export-image.png': exportImage,
  '../images/inspection-showcase.gif': inspectionShowcase,
  ...
  '../images/negated-gate.gif': negatedGate,
