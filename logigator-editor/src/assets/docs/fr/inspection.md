...
![Un circuit en cours d'exécution avec une fenêtre d'inspection flottant au-dessus du plan de travail, montrant le contenu en direct d'un composant.](images/inspection/inspection-overview.png)
...
![La fenêtre d'inspection de mémoire montrant une grille de valeurs stockées, le mot actuellement adressé mis en évidence, avec les contrôles de vue/base et l'indicateur d'adresse en haut.](images/inspection/rom-inspection.png)
...
![Une fenêtre de surveillance de composant personnalisé montrant le circuit interne en direct, avec un fil d'Ariane en haut pour naviguer dans les composants imbriqués.](images/inspection/custom-watch.png)
