...
![Un circuito en ejecución con una ventana de inspección flotando sobre el tablero, mostrando el contenido en directo de un componente.](images/inspection/inspection-overview.png)
...
![La ventana de inspección de memoria mostrando una cuadrícula de valores almacenados, con la palabra direccionada actualmente resaltada, los controles de vista/base y la lectura de dirección en la parte superior.](images/inspection/rom-inspection.png)
...
![Una ventana de monitor de componente personalizado mostrando el circuito interno en directo, con un rastro de migas de pan en la parte superior para navegar por los componentes anidados.](images/inspection/custom-watch.png)
