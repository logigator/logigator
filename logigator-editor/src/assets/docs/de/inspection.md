...
![Eine laufende Schaltung mit einem Inspektionsfenster, das über der Arbeitsfläche schwebt und den Live-Inhalt einer Komponente zeigt.](images/inspection/inspection-overview.png)
...
![Das Speicher-Inspektionsfenster mit einem Raster gespeicherter Werte, dem gerade adressierten Wort hervorgehoben, mit den Ansichts-/Basis-Steuerungen und der Adressanzeige oben.](images/inspection/rom-inspection.png)
...
![Ein Beobachtungsfenster einer benutzerdefinierten Komponente, das die innere Live-Schaltung zeigt, mit einer Brotkrümel-Spur oben zum Navigieren verschachtelter Komponenten.](images/inspection/custom-watch.png)
