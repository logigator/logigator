...
![The account and settings panel open, showing the Theme selector, the Language dropdown and the Editor Settings toggles.](images/settings/settings-panel.png)
