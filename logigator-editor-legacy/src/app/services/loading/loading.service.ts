...
export class LoadingService {
	...
	constructor(private componentFactoryResolver: ComponentFactoryResolver) {
		this._factory = this.componentFactoryResolver.resolveComponentFactory(
	...
	public add(
		...
		if (instance && showTextInContainer) instance.instance.text = text;
